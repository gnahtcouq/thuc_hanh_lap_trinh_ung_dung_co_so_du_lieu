...
--
-- Host: localhost
-- Generation Time: Dec 23, 2014 at 01:48 AM
...
(78, 'San Miguel de Tucum', 'ARG', 'Tucum', 470809),
(79, 'Lan?s', 'ARG', 'Buenos Aires', 469735),
(80, 'Merlo', 'ARG', 'Buenos Aires', 463846),
(81, 'General San Mart', 'ARG', 'Buenos Aires', 422542),
...
(97, 'Esteban Echeverr', 'ARG', 'Buenos Aires', 235760),
...
(103, 'Guaymall', 'ARG', 'Mendoza', 200595),
...
(216, 'Bel', 'BRA', 'Par', 1186926),
(217, 'Guarulhos', 'BRA', 'S?o Paulo', 1095874),
(218, 'Goi?nia', 'BRA', 'Goi', 1056330),
(219, 'Campinas', 'BRA', 'S?o Paulo', 950043),
(220, 'S?o Gon?alo', 'BRA', 'Rio de Janeiro', 869254),
(221, 'Nova Igua', 'BRA', 'Rio de Janeiro', 862225),
(222, 'S?o Lu', 'BRA', 'Maranh', 837588),
...
(258, 'Aparecida de Goi?nia', 'BRA', 'Goi', 324662),
...
(280, 'Foz do Igua', 'BRA', 'Paran', 259425),
...
(299, 'Imperatriz', 'BRA', 'Maranh', 224564),
...
(306, 'Viam', 'BRA', 'Rio Grande do Sul', 207557),
...
(374, 'Timon', 'BRA', 'Maranh', 125812),
(375, 'Luzi?nia', 'BRA', 'Goi', 125597),
(376, 'Maca', 'BRA', 'Rio de Janeiro', 125597),
(377, 'Te?filo Otoni', 'BRA', 'Minas Gerais', 124489),
(378, 'Moji-Gua', 'BRA', 'S?o Paulo', 123782),
...
(392, 'Vit?ria de Santo Ant', 'BRA', 'Pernambuco', 113595),
...
(413, 'Cod?', 'BRA', 'Maranh', 103153),
(414, 'Jaragu? do Sul', 'BRA', 'Santa Catarina', 102580),
(415, 'Cubat', 'BRA', 'S?o Paulo', 102372),
...
(426, 'S?o Jos? de Ribamar', 'BRA', 'Maranh', 98318),
...
(580, 'Coronel', 'CHL', 'B?ob', 93061),
(581, 'San Pedro de la Paz', 'CHL', 'B?ob', 91684),
...
(587, 'Santo Domingo de Guzm', 'DOM', 'Distrito Nacional', 1609966),
(588, 'Santiago de los Caballeros', 'DOM', 'Santiago', 365463),
(589, 'La Romana', 'DOM', 'La Romana', 140204),
(590, 'San Pedro de Macor', 'DOM', 'San Pedro de Macor', 124735),
(591, 'San Francisco de Macor', 'DOM', 'Duarte', 108485),
...
(681, 'Donostia-San Sebasti', 'ESP', 'Baskimaa', 179208),
(682, 'Cartagena', 'ESP', 'Murcia', 177709),
(683, 'Legan', 'ESP', 'Madrid', 173163),
(684, 'Fuenlabrada', 'ESP', 'Madrid', 171173),
(685, 'Almer', 'ESP', 'Andalusia', 169027),
...
(934, 'San Pedro Sula', 'HND', 'Cort', 383900),
...
(1449, 'Reykjav', 'ISL', 'H?fu?borgarsv??i', 109184),
...
(2259, 'Medell', 'COL', 'Antioquia', 1861265),
...
(2544, 'Chimalhuac', 'MEX', 'M?xico', 490245),
...
(2551, 'Tultitl', 'MEX', 'M?xico', 432411),
...
(2557, 'Mazatl', 'MEX', 'Sinaloa', 380265),
...
(2598, 'San Juan del R', 'MEX', 'Quer?taro', 179300),
...
(2612, 'Minatitl', 'MEX', 'Veracruz', 152983),
...
(2622, 'Boca del R', 'MEX', 'Veracruz-Llave', 135721),
...
(2636, 'San Pedro Garza Garc', 'MEX', 'Nuevo Le?n', 126147),
...
(2648, 'Apatzing', 'MEX', 'Michoac?n de Ocampo', 117849),
...
(2662, 'Cunduac', 'MEX', 'Tabasco', 104164),
...
(3049, 'Gothenburg [G?teborg]', 'SWE', 'West G?tanmaan l', 466990),
(3050, 'Malm?', 'SWE', 'Sk?ne l', 259579),
(3051, 'Uppsala', 'SWE', 'Uppsala l', 189569),
(3052, 'Link?ping', 'SWE', 'East G?tanmaan l', 133168),
(3053, 'V?ster', 'SWE', 'V?stmanlands l', 126328),
(3054, '?rebro', 'SWE', '?rebros l', 124207),
(3055, 'Norrk?ping', 'SWE', 'East G?tanmaan l', 122199),
(3056, 'Helsingborg', 'SWE', 'Sk?ne l', 117737),
(3057, 'J?nk?ping', 'SWE', 'J?nk?pings l', 117095),
(3058, 'Ume', 'SWE', 'V?sterbottens l', 104512),
(3059, 'Lund', 'SWE', 'Sk?ne l', 98948),
(3060, 'Bor', 'SWE', 'West G?tanmaan l', 96883),
(3061, 'Sundsvall', 'SWE', 'V?sternorrlands l', 93126),
(3062, 'G?vle', 'SWE', 'G?vleborgs l', 90742),
...
(3485, 'Miskolc', 'HUN', 'Borsod-Aba?j-Zempl', 172357),
(3486, 'Szeged', 'HUN', 'Csongr', 158158),
(3487, 'P?cs', 'HUN', 'Baranya', 157332),
(3488, 'Gy?r', 'HUN', 'Gy?r-Moson-Sopron', 127119),
(3489, 'Nyiregyh?za', 'HUN', 'Szabolcs-Szatm?r-Ber', 112419),
(3490, 'Kecskem', 'HUN', 'B?cs-Kiskun', 105606),
(3491, 'Sz?kesfeh?rv', 'HUN', 'Fej', 105119),
...
(3785, 'Phan Thi', 'VNM', 'Binh Thuan', 114236),
...
INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LocalName`, `HeadOfState`) VALUES
('ABW', 'Aruba', 'North America', 'Caribbean', 193.00, NULL, 103000, 'Aruba', 'Beatrix'),
('AFG', 'Afghanistan', 'Asia', 'Southern and Central Asia', 652090.00, 1919, 22720000, 'Afganistan/Afqanestan', 'Mohammad Omar'),
('AGO', 'Angola', 'Africa', 'Central Africa', 1246700.00, 1975, 12878000, 'Angola', 'José Eduardo dos Santos'),
('AIA', 'Anguilla', 'North America', 'Caribbean', 96.00, NULL, 8000, 'Anguilla', 'Elisabeth II'),
('ALB', 'Albania', 'Europe', 'Southern Europe', 28748.00, 1912, 3401200, 'Shqipëria', 'Rexhep Mejdani'),
('AND', 'Andorra', 'Europe', 'Southern Europe', 468.00, 1278, 78000, 'Andorra', ''),
('ANT', 'Netherlands Antilles', 'North America', 'Caribbean', 800.00, NULL, 217000, 'Nederlandse Antillen', 'Beatrix'),
('ARE', 'United Arab Emirates', 'Asia', 'Middle East', 83600.00, 1971, 2441000, 'Al-Imarat al-´Arabiya al-Muttahida', 'Zayid bin Sultan al-Nahayan'),
('ARG', 'Argentina', 'South America', 'South America', 2780400.00, 1816, 37032000, 'Argentina', 'Fernando de la Rúa'),
('ARM', 'Armenia', 'Asia', 'Middle East', 29800.00, 1991, 3520000, 'Hajastan', 'Robert Kotšarjan'),
('ASM', 'American Samoa', 'Oceania', 'Polynesia', 199.00, NULL, 68000, 'Amerika Samoa', 'George W. Bush'),
('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 13120000.00, NULL, 0, '–', ''),
('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 7780.00, NULL, 0, 'Terres australes françaises', 'Jacques Chirac'),
('ATG', 'Antigua and Barbuda', 'North America', 'Caribbean', 442.00, 1981, 68000, 'Antigua and Barbuda', 'Elisabeth II'),
('AUS', 'Australia', 'Oceania', 'Australia and New Zealand', 7741220.00, 1901, 18886000, 'Australia', 'Elisabeth II'),
('AUT', 'Austria', 'Europe', 'Western Europe', 83859.00, 1918, 8091800, 'Österreich', 'Thomas Klestil'),
('AZE', 'Azerbaijan', 'Asia', 'Middle East', 86600.00, 1991, 7734000, 'Azärbaycan', 'Heydär Äliyev'),
('BDI', 'Burundi', 'Africa', 'Eastern Africa', 27834.00, 1962, 6695000, 'Burundi/Uburundi', 'Pierre Buyoya'),
('BEL', 'Belgium', 'Europe', 'Western Europe', 30518.00, 1830, 10239000, 'België/Belgique', 'Albert II'),
('BEN', 'Benin', 'Africa', 'Western Africa', 112622.00, 1960, 6097000, 'Bénin', 'Mathieu Kérékou'),
('BFA', 'Burkina Faso', 'Africa', 'Western Africa', 274000.00, 1960, 11937000, 'Burkina Faso', 'Blaise Compaoré'),
('BGD', 'Bangladesh', 'Asia', 'Southern and Central Asia', 143998.00, 1971, 129155000, 'Bangladesh', 'Shahabuddin Ahmad'),
('BGR', 'Bulgaria', 'Europe', 'Eastern Europe', 110994.00, 1908, 8190900, 'Balgarija', 'Petar Stojanov'),
('BHR', 'Bahrain', 'Asia', 'Middle East', 694.00, 1971, 617000, 'Al-Bahrayn', 'Hamad ibn Isa al-Khalifa'),
('BHS', 'Bahamas', 'North America', 'Caribbean', 13878.00, 1973, 307000, 'The Bahamas', 'Elisabeth II'),
('BIH', 'Bosnia and Herzegovina', 'Europe', 'Southern Europe', 51197.00, 1992, 3972000, 'Bosna i Hercegovina', 'Ante Jelavic'),
('BLR', 'Belarus', 'Europe', 'Eastern Europe', 207600.00, 1991, 10236000, 'Belarus', 'Aljaksandr Lukašenka'),
('BLZ', 'Belize', 'North America', 'Central America', 22696.00, 1981, 241000, 'Belize', 'Elisabeth II'),
('BMU', 'Bermuda', 'North America', 'North America', 53.00, NULL, 65000, 'Bermuda', 'Elisabeth II'),
('BOL', 'Bolivia', 'South America', 'South America', 1098581.00, 1825, 8329000, 'Bolivia', 'Hugo Bánzer Suárez'),
('BRA', 'Brazil', 'South America', 'South America', 8547403.00, 1822, 170115000, 'Brasil', 'Fernando Henrique Cardoso'),
('BRB', 'Barbados', 'North America', 'Caribbean', 430.00, 1966, 270000, 'Barbados', 'Elisabeth II'),
('BRN', 'Brunei', 'Asia', 'Southeast Asia', 5765.00, 1984, 328000, 'Brunei Darussalam', 'Haji Hassan al-Bolkiah'),
('BTN', 'Bhutan', 'Asia', 'Southern and Central Asia', 47000.00, 1910, 2124000, 'Druk-Yul', 'Jigme Singye Wangchuk'),
('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59.00, NULL, 0, 'Bouvetøya', 'Harald V'),
('BWA', 'Botswana', 'Africa', 'Southern Africa', 581730.00, 1966, 1622000, 'Botswana', 'Festus G. Mogae'),
('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984.00, 1960, 3615000, 'Centrafrique/Bê-Afrîka', 'Ange-Félix Patassé'),
('CAN', 'Canada', 'North America', 'North America', 9970610.00, 1867, 31147000, 'Canada', 'Elisabeth II'),
('CCK', 'Cocos (Keeling) Islands', 'Oceania', 'Australia and New Zealand', 14.00, NULL, 600, 'Cocos (Keeling) Islands', 'Elisabeth II'),
('CHE', 'Switzerland', 'Europe', 'Western Europe', 41284.00, 1499, 7160400, 'Schweiz/Suisse/Svizzera/Svizra', 'Adolf Ogi'),
('CHL', 'Chile', 'South America', 'South America', 756626.00, 1810, 15211000, 'Chile', 'Ricardo Lagos Escobar'),
('CHN', 'China', 'Asia', 'Eastern Asia', 9572900.00, -1523, 1277558000, 'Zhongquo', 'Jiang Zemin'),
('CIV', 'Côte d’Ivoire', 'Africa', 'Western Africa', 322463.00, 1960, 14786000, 'Côte d’Ivoire', 'Laurent Gbagbo'),
('CMR', 'Cameroon', 'Africa', 'Central Africa', 475442.00, 1960, 15085000, 'Cameroun/Cameroon', 'Paul Biya'),
('COD', 'Congo, The Democratic Republic of the', 'Africa', 'Central Africa', 2344858.00, 1960, 51654000, 'République Démocratique du Congo', 'Joseph Kabila'),
('COG', 'Congo', 'Africa', 'Central Africa', 342000.00, 1960, 2943000, 'Congo', 'Denis Sassou-Nguesso'),
('COK', 'Cook Islands', 'Oceania', 'Polynesia', 236.00, NULL, 20000, 'The Cook Islands', 'Elisabeth II'),
('COL', 'Colombia', 'South America', 'South America', 1138914.00, 1810, 42321000, 'Colombia', 'Andrés Pastrana Arango'),
('COM', 'Comoros', 'Africa', 'Eastern Africa', 1862.00, 1975, 578000, 'Komori/Comores', 'Azali Assoumani'),
('CPV', 'Cape Verde', 'Africa', 'Western Africa', 4033.00, 1975, 428000, 'Cabo Verde', 'António Mascarenhas Monteiro'),
('CRI', 'Costa Rica', 'North America', 'Central America', 51100.00, 1821, 4023000, 'Costa Rica', 'Miguel Ángel Rodríguez Echeverría'),
('CUB', 'Cuba', 'North America', 'Caribbean', 110861.00, 1902, 11201000, 'Cuba', 'Fidel Castro Ruz'),
('CXR', 'Christmas Island', 'Oceania', 'Australia and New Zealand', 135.00, NULL, 2500, 'Christmas Island', 'Elisabeth II'),
('CYM', 'Cayman Islands', 'North America', 'Caribbean', 264.00, NULL, 38000, 'Cayman Islands', 'Elisabeth II'),
('CYP', 'Cyprus', 'Asia', 'Middle East', 9251.00, 1960, 754700, 'Kýpros/Kibris', 'Glafkos Klerides'),
('CZE', 'Czech Republic', 'Europe', 'Eastern Europe', 78866.00, 1993, 10278100, '¸esko', 'Václav Havel'),
('DEU', 'Germany', 'Europe', 'Western Europe', 357022.00, 1955, 82164700, 'Deutschland', 'Johannes Rau'),
('DJI', 'Djibouti', 'Africa', 'Eastern Africa', 23200.00, 1977, 638000, 'Djibouti/Jibuti', 'Ismail Omar Guelleh'),
('DMA', 'Dominica', 'North America', 'Caribbean', 751.00, 1978, 71000, 'Dominica', 'Vernon Shaw'),
('DNK', 'Denmark', 'Europe', 'Nordic Countries', 43094.00, 800, 5330000, 'Danmark', 'Margrethe II'),
('DOM', 'Dominican Republic', 'North America', 'Caribbean', 48511.00, 1844, 8495000, 'República Dominicana', 'Hipólito Mejía Domínguez'),
('DZA', 'Algeria', 'Africa', 'Northern Africa', 2381741.00, 1962, 31471000, 'Al-Jaza’ir/Algérie', 'Abdelaziz Bouteflika'),
('ECU', 'Ecuador', 'South America', 'South America', 283561.00, 1822, 12646000, 'Ecuador', 'Gustavo Noboa Bejarano'),
('EGY', 'Egypt', 'Africa', 'Northern Africa', 1001449.00, 1922, 68470000, 'Misr', 'Hosni Mubarak'),
('ERI', 'Eritrea', 'Africa', 'Eastern Africa', 117600.00, 1993, 3850000, 'Ertra', 'Isayas Afewerki [Isaias Afwerki]'),
('ESH', 'Western Sahara', 'Africa', 'Northern Africa', 266000.00, NULL, 293000, 'As-Sahrawiya', 'Mohammed Abdel Aziz'),
('ESP', 'Spain', 'Europe', 'Southern Europe', 505992.00, 1492, 39441700, 'España', 'Juan Carlos I'),
('EST', 'Estonia', 'Europe', 'Baltic Countries', 45227.00, 1991, 1439200, 'Eesti', 'Lennart Meri'),
('ETH', 'Ethiopia', 'Africa', 'Eastern Africa', 1104300.00, -1000, 62565000, 'YeItyop´iya', 'Negasso Gidada'),
('FIN', 'Finland', 'Europe', 'Nordic Countries', 338145.00, 1917, 5171300, 'Suomi', 'Tarja Halonen'),
('FJI', 'Fiji Islands', 'Oceania', 'Melanesia', 18274.00, 1970, 817000, 'Fiji Islands', 'Josefa Iloilo'),
('FLK', 'Falkland Islands', 'South America', 'South America', 12173.00, NULL, 2000, 'Falkland Islands', 'Elisabeth II'),
('FRA', 'France', 'Europe', 'Western Europe', 551500.00, 843, 59225700, 'France', 'Jacques Chirac'),
('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399.00, NULL, 43000, 'Føroyar', 'Margrethe II'),
('FSM', 'Micronesia, Federated States of', 'Oceania', 'Micronesia', 702.00, 1990, 119000, 'Micronesia', 'Leo A. Falcam'),
('GAB', 'Gabon', 'Africa', 'Central Africa', 267668.00, 1960, 1226000, 'Le Gabon', 'Omar Bongo'),
('GBR', 'United Kingdom', 'Europe', 'British Islands', 242900.00, 1066, 59623400, 'United Kingdom', 'Elisabeth II'),
('GEO', 'Georgia', 'Asia', 'Middle East', 69700.00, 1991, 4968000, 'Sakartvelo', 'Eduard Ševardnadze'),
('GHA', 'Ghana', 'Africa', 'Western Africa', 238533.00, 1957, 20212000, 'Ghana', 'John Kufuor'),
('GIB', 'Gibraltar', 'Europe', 'Southern Europe', 6.00, NULL, 25000, 'Gibraltar', 'Elisabeth II'),
('GIN', 'Guinea', 'Africa', 'Western Africa', 245857.00, 1958, 7430000, 'Guinée', 'Lansana Conté'),
('GLP', 'Guadeloupe', 'North America', 'Caribbean', 1705.00, NULL, 456000, 'Guadeloupe', 'Jacques Chirac'),
('GMB', 'Gambia', 'Africa', 'Western Africa', 11295.00, 1965, 1305000, 'The Gambia', 'Yahya Jammeh'),
('GNB', 'Guinea-Bissau', 'Africa', 'Western Africa', 36125.00, 1974, 1213000, 'Guiné-Bissau', 'Kumba Ialá'),
('GNQ', 'Equatorial Guinea', 'Africa', 'Central Africa', 28051.00, 1968, 453000, 'Guinea Ecuatorial', 'Teodoro Obiang Nguema Mbasogo'),
('GRC', 'Greece', 'Europe', 'Southern Europe', 131626.00, 1830, 10545700, 'Elláda', 'Kostis Stefanopoulos'),
('GRD', 'Grenada', 'North America', 'Caribbean', 344.00, 1974, 94000, 'Grenada', 'Elisabeth II'),
('GRL', 'Greenland', 'North America', 'North America', 2166090.00, NULL, 56000, 'Kalaallit Nunaat/Grønland', 'Margrethe II'),
('GTM', 'Guatemala', 'North America', 'Central America', 108889.00, 1821, 11385000, 'Guatemala', 'Alfonso Portillo Cabrera'),
('GUF', 'French Guiana', 'South America', 'South America', 90000.00, NULL, 181000, 'Guyane française', 'Jacques Chirac'),
('GUM', 'Guam', 'Oceania', 'Micronesia', 549.00, NULL, 168000, 'Guam', 'George W. Bush'),
('GUY', 'Guyana', 'South America', 'South America', 214969.00, 1966, 861000, 'Guyana', 'Bharrat Jagdeo'),
('HKG', 'Hong Kong', 'Asia', 'Eastern Asia', 1075.00, NULL, 6782000, 'Xianggang/Hong Kong', 'Jiang Zemin'),
('HMD', 'Heard Island and McDonald Islands', 'Antarctica', 'Antarctica', 359.00, NULL, 0, 'Heard and McDonald Islands', 'Elisabeth II'),
('HND', 'Honduras', 'North America', 'Central America', 112088.00, 1838, 6485000, 'Honduras', 'Carlos Roberto Flores Facussé'),
('HRV', 'Croatia', 'Europe', 'Southern Europe', 56538.00, 1991, 4473000, 'Hrvatska', 'Štipe Mesic'),
('HTI', 'Haiti', 'North America', 'Caribbean', 27750.00, 1804, 8222000, 'Haïti/Dayti', 'Jean-Bertrand Aristide'),
('HUN', 'Hungary', 'Europe', 'Eastern Europe', 93030.00, 1918, 10043200, 'Magyarország', 'Ferenc Mádl'),
('IDN', 'Indonesia', 'Asia', 'Southeast Asia', 1904569.00, 1945, 212107000, 'Indonesia', 'Abdurrahman Wahid'),
('IND', 'India', 'Asia', 'Southern and Central Asia', 3287263.00, 1947, 1013662000, 'Bharat/India', 'Kocheril Raman Narayanan'),
('IOT', 'British Indian Ocean Territory', 'Africa', 'Eastern Africa', 78.00, NULL, 0, 'British Indian Ocean Territory', 'Elisabeth II'),
('IRL', 'Ireland', 'Europe', 'British Islands', 70273.00, 1921, 3775100, 'Ireland/Éire', 'Mary McAleese'),
('IRN', 'Iran', 'Asia', 'Southern and Central Asia', 1648195.00, 1906, 67702000, 'Iran', 'Ali Mohammad Khatami-Ardakani'),
('IRQ', 'Iraq', 'Asia', 'Middle East', 438317.00, 1932, 23115000, 'Al-´Iraq', 'Saddam Hussein al-Takriti'),
('ISL', 'Iceland', 'Europe', 'Nordic Countries', 103000.00, 1944, 279000, 'Ísland', 'Ólafur Ragnar Grímsson'),
('ISR', 'Israel', 'Asia', 'Middle East', 21056.00, 1948, 6217000, 'Yisra’el/Isra’il', 'Moshe Katzav'),
('ITA', 'Italy', 'Europe', 'Southern Europe', 301316.00, 1861, 57680000, 'Italia', 'Carlo Azeglio Ciampi'),
('JAM', 'Jamaica', 'North America', 'Caribbean', 10990.00, 1962, 2583000, 'Jamaica', 'Elisabeth II'),
('JOR', 'Jordan', 'Asia', 'Middle East', 88946.00, 1946, 5083000, 'Al-Urdunn', 'Abdullah II'),
('JPN', 'Japan', 'Asia', 'Eastern Asia', 377829.00, -660, 126714000, 'Nihon/Nippon', 'Akihito'),
('KAZ', 'Kazakstan', 'Asia', 'Southern and Central Asia', 2724900.00, 1991, 16223000, 'Qazaqstan', 'Nursultan Nazarbajev'),
('KEN', 'Kenya', 'Africa', 'Eastern Africa', 580367.00, 1963, 30080000, 'Kenya', 'Daniel arap Moi'),
('KGZ', 'Kyrgyzstan', 'Asia', 'Southern and Central Asia', 199900.00, 1991, 4699000, 'Kyrgyzstan', 'Askar Akajev'),
('KHM', 'Cambodia', 'Asia', 'Southeast Asia', 181035.00, 1953, 11168000, 'Kâmpuchéa', 'Norodom Sihanouk'),
('KIR', 'Kiribati', 'Oceania', 'Micronesia', 726.00, 1979, 83000, 'Kiribati', 'Teburoro Tito'),
('KNA', 'Saint Kitts and Nevis', 'North America', 'Caribbean', 261.00, 1983, 38000, 'Saint Kitts and Nevis', 'Elisabeth II'),
('KOR', 'South Korea', 'Asia', 'Eastern Asia', 99434.00, 1948, 46844000, 'Taehan Min’guk (Namhan)', 'Kim Dae-jung'),
('KWT', 'Kuwait', 'Asia', 'Middle East', 17818.00, 1961, 1972000, 'Al-Kuwayt', 'Jabir al-Ahmad al-Jabir al-Sabah'),
('LAO', 'Laos', 'Asia', 'Southeast Asia', 236800.00, 1953, 5433000, 'Lao', 'Khamtay Siphandone'),
('LBN', 'Lebanon', 'Asia', 'Middle East', 10400.00, 1941, 3282000, 'Lubnan', 'Émile Lahoud'),
('LBR', 'Liberia', 'Africa', 'Western Africa', 111369.00, 1847, 3154000, 'Liberia', 'Charles Taylor'),
('LBY', 'Libyan Arab Jamahiriya', 'Africa', 'Northern Africa', 1759540.00, 1951, 5605000, 'Libiya', 'Muammar al-Qadhafi'),
('LCA', 'Saint Lucia', 'North America', 'Caribbean', 622.00, 1979, 154000, 'Saint Lucia', 'Elisabeth II'),
('LIE', 'Liechtenstein', 'Europe', 'Western Europe', 160.00, 1806, 32300, 'Liechtenstein', 'Hans-Adam II'),
('LKA', 'Sri Lanka', 'Asia', 'Southern and Central Asia', 65610.00, 1948, 18827000, 'Sri Lanka/Ilankai', 'Chandrika Kumaratunga'),
('LSO', 'Lesotho', 'Africa', 'Southern Africa', 30355.00, 1966, 2153000, 'Lesotho', 'Letsie III'),
('LTU', 'Lithuania', 'Europe', 'Baltic Countries', 65301.00, 1991, 3698500, 'Lietuva', 'Valdas Adamkus'),
('LUX', 'Luxembourg', 'Europe', 'Western Europe', 2586.00, 1867, 435700, 'Luxembourg/Lëtzebuerg', 'Henri'),
('LVA', 'Latvia', 'Europe', 'Baltic Countries', 64589.00, 1991, 2424200, 'Latvija', 'Vaira Vike-Freiberga'),
('MAC', 'Macao', 'Asia', 'Eastern Asia', 18.00, NULL, 473000, 'Macau/Aomen', 'Jiang Zemin'),
('MAR', 'Morocco', 'Africa', 'Northern Africa', 446550.00, 1956, 28351000, 'Al-Maghrib', 'Mohammed VI'),
('MCO', 'Monaco', 'Europe', 'Western Europe', 1.50, 1861, 34000, 'Monaco', 'Rainier III'),
('MDA', 'Moldova', 'Europe', 'Eastern Europe', 33851.00, 1991, 4380000, 'Moldova', 'Vladimir Voronin'),
('MDG', 'Madagascar', 'Africa', 'Eastern Africa', 587041.00, 1960, 15942000, 'Madagasikara/Madagascar', 'Didier Ratsiraka'),
('MDV', 'Maldives', 'Asia', 'Southern and Central Asia', 298.00, 1965, 286000, 'Dhivehi Raajje/Maldives', 'Maumoon Abdul Gayoom'),
('MEX', 'Mexico', 'North America', 'Central America', 1958201.00, 1810, 98881000, 'México', 'Vicente Fox Quesada'),
('MHL', 'Marshall Islands', 'Oceania', 'Micronesia', 181.00, 1990, 64000, 'Marshall Islands/Majol', 'Kessai Note'),
('MKD', 'Macedonia', 'Europe', 'Southern Europe', 25713.00, 1991, 2024000, 'Makedonija', 'Boris Trajkovski'),
('MLI', 'Mali', 'Africa', 'Western Africa', 1240192.00, 1960, 11234000, 'Mali', 'Alpha Oumar Konaré'),
('MLT', 'Malta', 'Europe', 'Southern Europe', 316.00, 1964, 380200, 'Malta', 'Guido de Marco'),
('MMR', 'Myanmar', 'Asia', 'Southeast Asia', 676578.00, 1948, 45611000, 'Myanma Pye', 'kenraali Than Shwe'),
('MNG', 'Mongolia', 'Asia', 'Eastern Asia', 1566500.00, 1921, 2662000, 'Mongol Uls', 'Natsagiin Bagabandi'),
('MNP', 'Northern Mariana Islands', 'Oceania', 'Micronesia', 464.00, NULL, 78000, 'Northern Mariana Islands', 'George W. Bush'),
('MOZ', 'Mozambique', 'Africa', 'Eastern Africa', 801590.00, 1975, 19680000, 'Moçambique', 'Joaquím A. Chissano'),
('MRT', 'Mauritania', 'Africa', 'Western Africa', 1025520.00, 1960, 2670000, 'Muritaniya/Mauritanie', 'Maaouiya Ould Sid´Ahmad Taya'),
('MSR', 'Montserrat', 'North America', 'Caribbean', 102.00, NULL, 11000, 'Montserrat', 'Elisabeth II'),
('MTQ', 'Martinique', 'North America', 'Caribbean', 1102.00, NULL, 395000, 'Martinique', 'Jacques Chirac'),
('MUS', 'Mauritius', 'Africa', 'Eastern Africa', 2040.00, 1968, 1158000, 'Mauritius', 'Cassam Uteem'),
('MWI', 'Malawi', 'Africa', 'Eastern Africa', 118484.00, 1964, 10925000, 'Malawi', 'Bakili Muluzi'),
('MYS', 'Malaysia', 'Asia', 'Southeast Asia', 329758.00, 1957, 22244000, 'Malaysia', 'Salahuddin Abdul Aziz Shah Alhaj'),
('MYT', 'Mayotte', 'Africa', 'Eastern Africa', 373.00, NULL, 149000, 'Mayotte', 'Jacques Chirac'),
('NAM', 'Namibia', 'Africa', 'Southern Africa', 824292.00, 1990, 1726000, 'Namibia', 'Sam Nujoma'),
('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 18575.00, NULL, 214000, 'Nouvelle-Calédonie', 'Jacques Chirac'),
('NER', 'Niger', 'Africa', 'Western Africa', 1267000.00, 1960, 10730000, 'Niger', 'Mamadou Tandja'),
('NFK', 'Norfolk Island', 'Oceania', 'Australia and New Zealand', 36.00, NULL, 2000, 'Norfolk Island', 'Elisabeth II'),
('NGA', 'Nigeria', 'Africa', 'Western Africa', 923768.00, 1960, 111506000, 'Nigeria', 'Olusegun Obasanjo'),
('NIC', 'Nicaragua', 'North America', 'Central America', 130000.00, 1838, 5074000, 'Nicaragua', 'Arnoldo Alemán Lacayo'),
('NIU', 'Niue', 'Oceania', 'Polynesia', 260.00, NULL, 2000, 'Niue', 'Elisabeth II'),
('NLD', 'Netherlands', 'Europe', 'Western Europe', 41526.00, 1581, 15864000, 'Nederland', 'Beatrix'),
('NOR', 'Norway', 'Europe', 'Nordic Countries', 323877.00, 1905, 4478500, 'Norge', 'Harald V'),
('NPL', 'Nepal', 'Asia', 'Southern and Central Asia', 147181.00, 1769, 23930000, 'Nepal', 'Gyanendra Bir Bikram'),
('NRU', 'Nauru', 'Oceania', 'Micronesia', 21.00, 1968, 12000, 'Naoero/Nauru', 'Bernard Dowiyogo'),
('NZL', 'New Zealand', 'Oceania', 'Australia and New Zealand', 270534.00, 1907, 3862000, 'New Zealand/Aotearoa', 'Elisabeth II'),
('OMN', 'Oman', 'Asia', 'Middle East', 309500.00, 1951, 2542000, '´Uman', 'Qabus ibn Sa´id'),
('PAK', 'Pakistan', 'Asia', 'Southern and Central Asia', 796095.00, 1947, 156483000, 'Pakistan', 'Mohammad Rafiq Tarar'),
('PAN', 'Panama', 'North America', 'Central America', 75517.00, 1903, 2856000, 'Panamá', 'Mireya Elisa Moscoso Rodríguez'),
('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 49.00, NULL, 50, 'Pitcairn', 'Elisabeth II'),
('PER', 'Peru', 'South America', 'South America', 1285216.00, 1821, 25662000, 'Perú/Piruw', 'Valentin Paniagua Corazao'),
('PHL', 'Philippines', 'Asia', 'Southeast Asia', 300000.00, 1946, 75967000, 'Pilipinas', 'Gloria Macapagal-Arroyo'),
('PLW', 'Palau', 'Oceania', 'Micronesia', 459.00, 1994, 19000, 'Belau/Palau', 'Kuniwo Nakamura'),
('PNG', 'Papua New Guinea', 'Oceania', 'Melanesia', 462840.00, 1975, 4807000, 'Papua New Guinea/Papua Niugini', 'Elisabeth II'),
('POL', 'Poland', 'Europe', 'Eastern Europe', 323250.00, 1918, 38653600, 'Polska', 'Aleksander Kwasniewski'),
('PRI', 'Puerto Rico', 'North America', 'Caribbean', 8875.00, NULL, 3869000, 'Puerto Rico', 'George W. Bush'),
('PRK', 'North Korea', 'Asia', 'Eastern Asia', 120538.00, 1948, 24039000, 'Choson Minjujuui In´min Konghwaguk (Bukhan)', 'Kim Jong-il'),
('PRT', 'Portugal', 'Europe', 'Southern Europe', 91982.00, 1143, 9997600, 'Portugal', 'Jorge Sampãio'),
('PRY', 'Paraguay', 'South America', 'South America', 406752.00, 1811, 5496000, 'Paraguay', 'Luis Ángel González Macchi'),
('PSE', 'Palestine', 'Asia', 'Middle East', 6257.00, NULL, 3101000, 'Filastin', 'Yasser (Yasir) Arafat'),
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000.00, NULL, 235000, 'Polynésie française', 'Jacques Chirac'),
('QAT', 'Qatar', 'Asia', 'Middle East', 11000.00, 1971, 599000, 'Qatar', 'Hamad ibn Khalifa al-Thani'),
('REU', 'Réunion', 'Africa', 'Eastern Africa', 2510.00, NULL, 699000, 'Réunion', 'Jacques Chirac'),
('ROM', 'Romania', 'Europe', 'Eastern Europe', 238391.00, 1878, 22455500, 'România', 'Ion Iliescu'),
('RUS', 'Russian Federation', 'Europe', 'Eastern Europe', 17075400.00, 1991, 146934000, 'Rossija', 'Vladimir Putin'),
('RWA', 'Rwanda', 'Africa', 'Eastern Africa', 26338.00, 1962, 7733000, 'Rwanda/Urwanda', 'Paul Kagame'),
('SAU', 'Saudi Arabia', 'Asia', 'Middle East', 2149690.00, 1932, 21607000, 'Al-´Arabiya as-Sa´udiya', 'Fahd ibn Abdul-Aziz al-Sa´ud'),
('SDN', 'Sudan', 'Africa', 'Northern Africa', 2505813.00, 1956, 29490000, 'As-Sudan', 'Omar Hassan Ahmad al-Bashir'),
('SEN', 'Senegal', 'Africa', 'Western Africa', 196722.00, 1960, 9481000, 'Sénégal/Sounougal', 'Abdoulaye Wade'),
('SGP', 'Singapore', 'Asia', 'Southeast Asia', 618.00, 1965, 3567000, 'Singapore/Singapura/Xinjiapo/Singapur', 'Sellapan Rama Nathan'),
('SGS', 'South Georgia and the South Sandwich Islands', 'Antarctica', 'Antarctica', 3903.00, NULL, 0, 'South Georgia and the South Sandwich Islands', 'Elisabeth II'),
('SHN', 'Saint Helena', 'Africa', 'Western Africa', 314.00, NULL, 6000, 'Saint Helena', 'Elisabeth II'),
('SJM', 'Svalbard and Jan Mayen', 'Europe', 'Nordic Countries', 62422.00, NULL, 3200, 'Svalbard og Jan Mayen', 'Harald V'),
('SLB', 'Solomon Islands', 'Oceania', 'Melanesia', 28896.00, 1978, 444000, 'Solomon Islands', 'Elisabeth II'),
('SLE', 'Sierra Leone', 'Africa', 'Western Africa', 71740.00, 1961, 4854000, 'Sierra Leone', 'Ahmed Tejan Kabbah'),
('SLV', 'El Salvador', 'North America', 'Central America', 21041.00, 1841, 6276000, 'El Salvador', 'Francisco Guillermo Flores Pérez'),
('SMR', 'San Marino', 'Europe', 'Southern Europe', 61.00, 885, 27000, 'San Marino', ''),
('SOM', 'Somalia', 'Africa', 'Eastern Africa', 637657.00, 1960, 10097000, 'Soomaaliya', 'Abdiqassim Salad Hassan'),
('SPM', 'Saint Pierre and Miquelon', 'North America', 'North America', 242.00, NULL, 7000, 'Saint-Pierre-et-Miquelon', 'Jacques Chirac'),
('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964.00, 1975, 147000, 'São Tomé e Príncipe', 'Miguel Trovoada'),
('SUR', 'Suriname', 'South America', 'South America', 163265.00, 1975, 417000, 'Suriname', 'Ronald Venetiaan'),
('SVK', 'Slovakia', 'Europe', 'Eastern Europe', 49012.00, 1993, 5398700, 'Slovensko', 'Rudolf Schuster'),
('SVN', 'Slovenia', 'Europe', 'Southern Europe', 20256.00, 1991, 1987800, 'Slovenija', 'Milan Kucan'),
('SWE', 'Sweden', 'Europe', 'Nordic Countries', 449964.00, 836, 8861400, 'Sverige', 'Carl XVI Gustaf'),
('SWZ', 'Swaziland', 'Africa', 'Southern Africa', 17364.00, 1968, 1008000, 'kaNgwane', 'Mswati III'),
('SYC', 'Seychelles', 'Africa', 'Eastern Africa', 455.00, 1976, 77000, 'Sesel/Seychelles', 'France-Albert René'),
('SYR', 'Syria', 'Asia', 'Middle East', 185180.00, 1941, 16125000, 'Suriya', 'Bashar al-Assad'),
('TCA', 'Turks and Caicos Islands', 'North America', 'Caribbean', 430.00, NULL, 17000, 'The Turks and Caicos Islands', 'Elisabeth II'),
('TCD', 'Chad', 'Africa', 'Central Africa', 1284000.00, 1960, 7651000, 'Tchad/Tshad', 'Idriss Déby'),
('TGO', 'Togo', 'Africa', 'Western Africa', 56785.00, 1960, 4629000, 'Togo', 'Gnassingbé Eyadéma'),
('THA', 'Thailand', 'Asia', 'Southeast Asia', 513115.00, 1350, 61399000, 'Prathet Thai', 'Bhumibol Adulyadej'),
('TJK', 'Tajikistan', 'Asia', 'Southern and Central Asia', 143100.00, 1991, 6188000, 'Toçikiston', 'Emomali Rahmonov'),
('TKL', 'Tokelau', 'Oceania', 'Polynesia', 12.00, NULL, 2000, 'Tokelau', 'Elisabeth II'),
('TKM', 'Turkmenistan', 'Asia', 'Southern and Central Asia', 488100.00, 1991, 4459000, 'Türkmenostan', 'Saparmurad Nijazov'),
('TMP', 'East Timor', 'Asia', 'Southeast Asia', 14874.00, NULL, 885000, 'Timor Timur', 'José Alexandre Gusmão'),
('TON', 'Tonga', 'Oceania', 'Polynesia', 650.00, 1970, 99000, 'Tonga', 'Taufa''ahau Tupou IV'),
('TTO', 'Trinidad and Tobago', 'North America', 'Caribbean', 5130.00, 1962, 1295000, 'Trinidad and Tobago', 'Arthur N. R. Robinson'),
('TUN', 'Tunisia', 'Africa', 'Northern Africa', 163610.00, 1956, 9586000, 'Tunis/Tunisie', 'Zine al-Abidine Ben Ali'),
('TUR', 'Turkey', 'Asia', 'Middle East', 774815.00, 1923, 66591000, 'Türkiye', 'Ahmet Necdet Sezer'),
('TUV', 'Tuvalu', 'Oceania', 'Polynesia', 26.00, 1978, 12000, 'Tuvalu', 'Elisabeth II'),
('TWN', 'Taiwan', 'Asia', 'Eastern Asia', 36188.00, 1945, 22256000, 'T’ai-wan', 'Chen Shui-bian'),
('TZA', 'Tanzania', 'Africa', 'Eastern Africa', 883749.00, 1961, 33517000, 'Tanzania', 'Benjamin William Mkapa'),
('UGA', 'Uganda', 'Africa', 'Eastern Africa', 241038.00, 1962, 21778000, 'Uganda', 'Yoweri Museveni'),
('UKR', 'Ukraine', 'Europe', 'Eastern Europe', 603700.00, 1991, 50456000, 'Ukrajina', 'Leonid Kutšma'),
('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia/Caribbean', 16.00, NULL, 0, 'United States Minor Outlying Islands', 'George W. Bush'),
('URY', 'Uruguay', 'South America', 'South America', 175016.00, 1828, 3337000, 'Uruguay', 'Jorge Batlle Ibáñez'),
('USA', 'United States', 'North America', 'North America', 9363520.00, 1776, 278357000, 'United States', 'George W. Bush'),
('UZB', 'Uzbekistan', 'Asia', 'Southern and Central Asia', 447400.00, 1991, 24318000, 'Uzbekiston', 'Islam Karimov'),
('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0.40, 1929, 1000, 'Santa Sede/Città del Vaticano', 'Johannes Paavali II'),
('VCT', 'Saint Vincent and the Grenadines', 'North America', 'Caribbean', 388.00, 1979, 114000, 'Saint Vincent and the Grenadines', 'Elisabeth II'),
('VEN', 'Venezuela', 'South America', 'South America', 912050.00, 1811, 24170000, 'Venezuela', 'Hugo Chávez Frías'),
('VGB', 'Virgin Islands, British', 'North America', 'Caribbean', 151.00, NULL, 21000, 'British Virgin Islands', 'Elisabeth II'),
('VIR', 'Virgin Islands, U.S.', 'North America', 'Caribbean', 347.00, NULL, 93000, 'Virgin Islands of the United States', 'George W. Bush'),
('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 331689.00, 1945, 79832000, 'Viêt Nam', 'Trân Duc Luong'),
('VUT', 'Vanuatu', 'Oceania', 'Melanesia', 12189.00, 1980, 190000, 'Vanuatu', 'John Bani'),
('WLF', 'Wallis and Futuna', 'Oceania', 'Polynesia', 200.00, NULL, 15000, 'Wallis-et-Futuna', 'Jacques Chirac'),
('WSM', 'Samoa', 'Oceania', 'Polynesia', 2831.00, 1962, 180000, 'Samoa', 'Malietoa Tanumafili II'),
('YEM', 'Yemen', 'Asia', 'Middle East', 527968.00, 1918, 18112000, 'Al-Yaman', 'Ali Abdallah Salih'),
('YUG', 'Yugoslavia', 'Europe', 'Southern Europe', 102173.00, 1918, 10640000, 'Jugoslavija', 'Vojislav Koštunica'),
('ZAF', 'South Africa', 'Africa', 'Southern Africa', 1221037.00, 1910, 40377000, 'South Africa', 'Thabo Mbeki'),
('ZMB', 'Zambia', 'Africa', 'Eastern Africa', 752618.00, 1964, 9169000, 'Zambia', 'Frederick Chiluba'),
('ZWE', 'Zimbabwe', 'Africa', 'Eastern Africa', 390757.00, 1980, 11669000, 'Zimbabwe', 'Robert G. Mugabe');
